...
export const misProyectos = [
  {
    ...
    titulo: "Click Veloz",
    descripcion:
      "Es el primer proyecto que realicé. Éste juego contiene 3 modos de dificultad. Para ganar debemos tocar todos los cuadrados blancos en el menor tiempo posible. Cuenta con un diseño adaptable.",
  ...
  },
  {
    ...
    descripcion:
      "Web con la que podemos crear, editar y borrar nuestras tareas. Cuenta con un diseño adaptable para todos los dispositivos. Almacena cada cambio realizado en el navegador del usuario (LocalStorage).",
  ...
  },
  {
    ...
    titulo: "Re-Con",
    descripcion:
      "App Web que nos permite llevar el registro de nuestros gastos mensuales ordenandolos por categoria y fecha. Para comenzar debemos registrarnos e iniciar sesion, luego podremos crear, editar y borrar nuestros gastos. ",
